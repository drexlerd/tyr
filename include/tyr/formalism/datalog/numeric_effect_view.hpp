...
#ifndef TYR_FORMALISM_DATALOG_NUMERIC_EFFECT_VIEW_HPP_
#define TYR_FORMALISM_DATALOG_NUMERIC_EFFECT_VIEW_HPP_
...
class View<Index<formalism::datalog::NumericEffect<Op, T>>, C>
{
private:
    const C* m_context;
    Index<formalism::datalog::NumericEffect<Op, T>> m_handle;

public:
    View(Index<formalism::datalog::NumericEffect<Op, T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
