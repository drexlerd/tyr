...
class View<Data<formalism::datalog::NumericEffectOperator<T>>, C>
{
private:
    const C* m_context;
    Data<formalism::datalog::NumericEffectOperator<T>> m_handle;

public:
    View(Data<formalism::datalog::NumericEffectOperator<T>> data, const C& context) noexcept : m_context(&context), m_handle(data) {}
...
auto make_view(const Data<formalism::datalog::NumericEffectOperator<T>>& element, const C& context) noexcept
{
    return View<Data<formalism::datalog::NumericEffectOperator<T>>, C>(
        element,
