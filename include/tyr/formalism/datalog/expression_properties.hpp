...
template<FactKind T>
void collect_fterms(float_t element, UnorderedSet<GroundFunctionTermView<T>>& result);

template<FactKind T1, FactKind T2>
void collect_fterms(FunctionTermView<T1> element, UnorderedSet<FunctionTermView<T2>>& result);

template<FactKind T1, FactKind T2>
void collect_fterms(GroundFunctionTermView<T1> element, UnorderedSet<GroundFunctionTermView<T2>>& result);

template<FactKind T>
void collect_fterms(FunctionExpressionView element, UnorderedSet<FunctionTermView<T>>& result);

template<FactKind T>
void collect_fterms(GroundFunctionExpressionView element, UnorderedSet<GroundFunctionTermView<T>>& result);
...
template<FactKind T, ArithmeticOpKind O>
void collect_fterms(GroundUnaryOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result);
...
template<FactKind T, OpKind O>
void collect_fterms(GroundBinaryOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result);

template<FactKind T, ArithmeticOpKind O>
void collect_fterms(LiftedMultiOperatorView<O> element, UnorderedSet<FunctionTermView<T>>& result);

template<FactKind T, ArithmeticOpKind O>
void collect_fterms(GroundMultiOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result);

template<FactKind T>
void collect_fterms(LiftedArithmeticOperatorView element, UnorderedSet<FunctionTermView<T>>& result);

template<FactKind T>
void collect_fterms(GroundArithmeticOperatorView element, UnorderedSet<GroundFunctionTermView<T>>& result);

template<FactKind T>
void collect_fterms(LiftedBooleanOperatorView element, UnorderedSet<FunctionTermView<T>>& result);

template<FactKind T>
void collect_fterms(GroundBooleanOperatorView element, UnorderedSet<GroundFunctionTermView<T>>& result);
...
template<FactKind T>
inline void collect_fterms(float_t element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
}
...
template<FactKind T1, FactKind T2>
inline void collect_fterms(GroundFunctionTermView<T1> element, UnorderedSet<GroundFunctionTermView<T2>>& result)
{
    if constexpr (std::same_as<T1, T2>)
        result.insert(element);
}
...
template<FactKind T>
inline void collect_fterms(GroundFunctionExpressionView element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    visit([&](auto&& arg) { collect_fterms(arg, result); }, element.get_variant());
}
...
template<FactKind T, ArithmeticOpKind O>
inline void collect_fterms(GroundUnaryOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    collect_fterms(element.get_arg(), result);
}
...
template<FactKind T, OpKind O>
inline void collect_fterms(GroundBinaryOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    collect_fterms(element.get_lhs(), result);
    collect_fterms(element.get_rhs(), result);
}
...
template<FactKind T, ArithmeticOpKind O>
inline void collect_fterms(GroundMultiOperatorView<O> element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    for (const auto& arg : element.get_args())
        collect_fterms(arg, result);
}
...
template<FactKind T>
inline void collect_fterms(GroundArithmeticOperatorView element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    visit([&](auto&& arg) { collect_fterms(arg, result); }, element.get_variant());
}
...
template<FactKind T>
inline void collect_fterms(GroundBooleanOperatorView element, UnorderedSet<GroundFunctionTermView<T>>& result)
{
    visit([&](auto&& arg) { collect_fterms(arg, result); }, element.get_variant());
}
...
{
    auto result = UnorderedSet<GroundFunctionTermView<T>> {};
    visit([&](auto&& arg) { collect_fterms(arg, result); }, element.get_variant());
    auto result_vec = std::vector<GroundFunctionTermView<T>>(result.begin(), result.end());
    std::sort(result_vec.begin(), result_vec.end(), Less<GroundFunctionTermView<T>> {});
    return result_vec;
}
}
