...
{
/*
template<std::unsigned_integral Block, typename Coder, size_t FirstSegmentSize, typename C>
class View<BitPackedArrayPool<Block, Coder, FirstSegmentSize>::template ConstArrayView<const Block>, C>
{
public:
    using Container = typename BitPackedArrayPool<Block, Coder, FirstSegmentSize>::ConstArrayView;
