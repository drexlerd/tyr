...
- `pyyggdrasil>=0.0.7` provides shared libraries, headers, and CMake packages for common native dependencies.
- `pypddl>=1.0.4` provides Loki's PDDL parser library, headers, and CMake package.
...
.venv/bin/python -m pip install pyyggdrasil>=0.0.7 pypddl>=1.0.4
```
